...
class Embed_Generator(commands.Cog):
    async def generate_embed(self, in_progress: bool, current_student: str, next_student: str):
        ...
        embed = discord.Embed(colour=discord.Colour(0xf95069), description=f"Office hours are currently {office_hours_status}.", timestamp=datetime.datetime.utcfromtimestamp(1600919771))
